...
void SPI_FLASH_Init(void)
{
	...
	/* SPI3 configuration */
	// W25Q16: data input on the DIO pin is sampled on the rising edge of the CLK. 
...
void SPI_FLASH_SectorErase(u32 SectorAddr)
{
	...
	SPI_FLASH_SendByte(W25Q_SectorErase);
...
void SPI_FLASH_BulkErase(void)
{
	...
	SPI_FLASH_SendByte(W25Q_ChipErase);
	/* Deselect the FLASH: Chip Select high */
	SPI_FLASH_CS_HIGH();
...
void SPI_FLASH_PageWrite(u8* pBuffer, u32 WriteAddr, u16 NumByteToWrite)
{
	...
	SPI_FLASH_SendByte(W25Q_PageProgram);
...
void SPI_FLASH_BufferRead(u8* pBuffer, u32 ReadAddr, u16 NumByteToRead)
{
	...
	SPI_FLASH_SendByte(W25Q_ReadData);
...
u32 SPI_FLASH_ReadID(void)
{
	...
	SPI_FLASH_SendByte(W25Q_JedecDeviceID);
...
void SPI_FLASH_WriteEnable(void)
{
	...
	/* Send "Write Enable" instruction */
	SPI_FLASH_SendByte(W25Q_WriteEnable);
...
void SPI_FLASH_WaitForWriteEnd(void)
{
  	...
  	SPI_FLASH_SendByte(W25Q_ReadStatusReg);
...
{ 
	...
	SPI_FLASH_SendByte(W25Q_PowerDown);
...
void SPI_Flash_WAKEUP(void)   
{
	...
	/* Send "Power Down" instruction */
	SPI_FLASH_SendByte(W25Q_ReleasePowerDown);
