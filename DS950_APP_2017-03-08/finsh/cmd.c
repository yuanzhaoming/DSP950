...
FINSH_FUNCTION_EXPORT(version, show product information);
...
FINSH_FUNCTION_EXPORT(ps, list thread);
MSH_CMD_EXPORT(ps, list thread);
...
FINSH_FUNCTION_EXPORT(help, list all symbol in system)
