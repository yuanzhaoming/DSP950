...
//	 rt_kprintf("Finsh sem rx_ind set\r\n");
    /* release semaphore to let finsh thread rx data */
    rt_sem_release(&shell->rx_sem);

//	rt_kprintf("Finsh sem rx_ind released\r\n");
...
//		rt_kprintf("finsh: rx_index seted\r\n"); 
    }
}
